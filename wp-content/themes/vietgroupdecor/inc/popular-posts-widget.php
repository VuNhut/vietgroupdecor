        ...
        <div class="widget tabbed">
            <div class="tabs-wrapper">
                <ul class="nav nav-tabs">
                      <li class="active"><a href="#popular-posts" data-toggle="tab"><?php esc_attr_e( 'Xem nhiều', 'dazzling' ); ?></a></li>
                      <li><a href="#recent" data-toggle="tab"><?php esc_attr_e( 'Gần đây', 'dazzling' ); ?></a></li>
